...
import de.stealwonders.epicsuite.commands.ApplyCommand;
...
import de.stealwonders.epicsuite.commands.PackUpdateCommand;
...
public final class EpicSuite extends JavaPlugin implements Listener {
    ...
    private void registerCommands() {
        commandManager.registerCommand(new ApplyCommand(this));
        ...
        commandManager.registerCommand(new PackUpdateCommand(this));
